...
format_in = markdown+footnotes+link_attributes
...
img_src = $(wildcard posts/images/*.jpg posts/images/*.png)
jpg_files = $(img_src:posts/images/%.jpg=build/images/%.jpg)
png_files = $(img_src:posts/images/%.png=build/images/%.png)
